		...
		<table><tr><td  valign="top">
			<table id="navigation"  width="230">
				<tr><td><a href="CustomerMain.jsp">Customer</a></td></tr>
							...
							<table class="center" cellpadding="25" width="1000" border="5">
								<tr>
									...
									<td width="176"><div align="center" class="style21">
										...
										<td width="176"><div align="center" class="style21">
											<span class="style23">Tickets </span>
										</div></td>
									<td width="200" height="40"><div align="center"
											class="style21">
											<span class="style23"> Book Ticket </span>
									</div></td>
									<%
									...
									String catName="NA";
									try {
										String query = "SELECT * from MOVIE where active_status='yes'";
								...
								<tr>
									...
									<td><div align="center"><form action="ticketconfirmation.jsp">
									<input type="hidden" name="mname" value="<%= a2 %>" />
									<label for="ticket_count"> Select Tickets </label>
									
									<input type="number" name="ticket_count" id="ticket_count" value="<%= count %>" />
                    ...
                    <%}else{ %>
               <td id="databar">
               		<h4>Please Login to Book Ticket</h4>
