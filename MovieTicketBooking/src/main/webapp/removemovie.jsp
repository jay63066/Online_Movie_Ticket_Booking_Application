		...
		<table><tr><td  valign="top">
			<table id="navigation"  width="230">
				<tr><td><a href="adminmain.jsp">Admin</a></td></tr>
                        ...
                        <% if(admin!=null){%>
                                <td id="databar">
                     <h4><span style="color:white">Remove Movie </span></h4>
							...
							<table class="center" cellpadding="25" width="1000" border="5">
								<tr>
									...
									<td width="200" height="40"><div align="center"
											class="style21">
											<span class="style23"> Remove Movie </span>
									</div></td>
									<%
								...
								<tr>
									...
									<td><div><a href="setmovieinactive.jsp?mid=<%= rs.getString(1) %>">Remove Movie</a></div></td>	
									<%
									}
									connection.close();
									}
                     ...
                     <%}else{ %>
               <td id="databar">
               		<h4>Please Login as Admin to Remove Outdated movies</h4>
               </td>
