      ...
      <div id="header">
        <div class="row-2">
          <ul>
            ...
            <li><a href="index.jsp">Contacts</a></li>
          </ul>
        </div>
      </div>
         </div>
	...
	<tr><td>
		<table><tr><td  valign="top">
			<table id="navigation"  width="170">
				...
				<tr><td><a href="customermain.jsp">Customers</a></td></tr>
				<tr><td><a href="movieschedule.jsp">Schedule</a></td></tr>
			</table>
		</td>
		<td id="databar">
			<img style="padding-top:10px;" src="images/cinemaworld.jpg" width="185%" height="420"/>
		</td>
		</tr>
	</table></td></tr>
</table>
...
<tr>
	<td style="background-color: black" >
            ...
            <a href="movieschedule.jsp"><span style="color:white">Schedule</span></a> |
		<a href="index.jsp"><span style="color:white">Privacy Policy</span></a>  |
		<a href="index.jsp"><span style="color:white">Contact us</span></a> |
		<a href="index.jsp"><span style="color:white">Disclaimer</span></a> |
		<a href="index.jsp"><span style="color:white">About us</span></a>
	</td>
</tr>
</table>
</body>
